...
func (book *ActivityBook) FindMostAsleepMinute(guardId int) int {
...
func main() {
	...
	guardId := activityBook.FindMostAsleepGuard()
	fmt.Printf("Guard #%d is the one sleeping the most\n", guardId)

	minute := activityBook.FindMostAsleepMinute(guardId)
	fmt.Printf("Guard #%d is most likely to be asleep at minute %d\n", guardId, minute)
